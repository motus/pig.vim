...
If you're using "pathogen":https://github.com/tpope/vim-pathogen to manage you aren't you), you can simply add this as a submodule in your `~/.vim/bundle/` directory.
