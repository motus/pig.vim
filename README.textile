...
If you're using "pathogen":https://github.com/tpope/vim-pathogen to manage your vim modules (and if you're not, why aren't you), you can simply add this as a submodule in your `~/.vim/bundle/` directory.
